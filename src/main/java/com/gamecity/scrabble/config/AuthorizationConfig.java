...
public class AuthorizationConfig extends AuthorizationServerConfigurerAdapter
{
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception
    {
        clients
            .inMemory() //
            .withClient(Constants.BASE_APP_TRUSTED_CLIENT) //
            .authorizedGrantTypes("password", "authorization_code", "refresh_token", "implicit") //
            .authorities("ROLE_CLIENT", "ROLE_TRUSTED_CLIENT") //
            .scopes("read", "write", "trust") //
            .secret(Constants.BASE_APP_SECRET) //
            .accessTokenValiditySeconds(Constants.TOKEN_VALIDITY_SECONDS) //
            .refreshTokenValiditySeconds(Constants.TOKEN_VALIDITY_SECONDS);
    }
    ...
    {
        oauthServer.realm(Constants.BASE_APP_SECURITY_REALM);
    }
}
